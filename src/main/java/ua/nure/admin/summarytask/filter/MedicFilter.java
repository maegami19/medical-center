...
@WebFilter(urlPatterns = {"/openMedcard", "/closeMedcard"})
public class MedicFilter implements Filter {
    @Override
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (user != null && (Constant.DOCTOR.equals(user.getRole()) || Constant.NURSE.equals(user.getRole()))) {
