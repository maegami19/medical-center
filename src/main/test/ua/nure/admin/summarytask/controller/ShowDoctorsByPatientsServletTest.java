...
public class ShowDoctorsByPatientsServletTest {

    private static final String SHOW_DOCTORS_PAGE = "pages/showDoctorsPage.jsp";
    private ShowDoctorsByPatientsServlet servlet;
    ...
    public void setUp() throws Exception {
        ...
        servlet = new ShowDoctorsByPatientsServlet();
    }
    ...
    public void doGetTest() throws ServletException, IOException {
        ...
        Mockito.verify(doctorService, Mockito.times(1)).getDoctorsByCountOfPatient();
